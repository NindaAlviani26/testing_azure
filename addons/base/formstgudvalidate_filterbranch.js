                    ...
                    jQuery("#" + msg.structure.idTable).jqGrid({
                        ...
                        onInitializeForm: function (formid) {
                            ...
                            setTimeout(function () {
                                ...
                                ($('.DataTD input#periode_data ').is('[readonly]') && $('.DataTD input#periode_data ').val() =='') ?  $('.DataTD input#periode_data').val(var_date) : '';
                                ($('.DataTD input#periodeData ').is('[readonly]') && $('.DataTD input#periodeData ').val() =='') ?  $('.DataTD input#periodeData').val(var_date) : '';
