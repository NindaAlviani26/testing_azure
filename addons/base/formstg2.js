    ...
    $.ajax({
        ...
        success: function (msg) {
            if (msg.status == 'success') {
                ...
                $.get("./templates/base/formstg.template", function (data) {
                    ...
                    function exportToCSV2() {
                        // var allRowsInGrid = $('#' + msg.structure.idTable).jqGrid('getGridParam','data');
                        // var allRowsInGrid = $('#'+ msg.structure.idTable).jqGrid('getGridParam');
                        // var s = jQuery("#"+msg.structure.idTable).jqGrid('getGridParam','data');
                        // // var s = jQuery("#"+msg.structure.idTable).jqGrid('getGridParam','userData');  
                        // console.log("cek");
                        // console.log(s);
                        ...
                        // $("#"+ msg.structure.idTable).excelexportjs({
                        //     containerid: "dvjson"
                        //        , datatype: 'json'
                        //        , dataset: loadData
                        ...
                        // createExcelFromGrid(msg.structure.idTable,'test');
                        // $('#'+msg.structure.idTable).jqGrid("exportToExcel",{
                        //     includeLabels : true,
                        //     includeGroupHeader : true,
                        //     includeFooter: true,
                        //     fileName : "jqGridExports.xlsx",
                        //     // maxlength : 1000 // maxlength for visible string data 
                        // });
                        // $('#'+msg.structure.idTable).jqGrid("excelExport",{
                        //     url : msg.structure.urlLoadData,
                        //     tag: 'xlsx',
                        // });
