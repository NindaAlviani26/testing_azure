        ...
        success: function (msg) {
            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/base/formstg_filter.template?v=8", function (data) {
                    ...
                    var this_day = get_date_x.getDay();
                    if(this_day ==1 || this_day ==2 || this_day ==3 || this_day ==4 || this_day ==5 || this_day ==6){
                    
                        get_date_x.setDate(get_date_x.getDate()-this_day);
                        filter_periode_data = year_y +'-'+ (month_y) +'-'+ get_date_x.getDate();
                    }else{
                        get_date_x = new Date(year_y,month_y-1,(get_date_x.getDate()-1));
                        this_day = get_date_x.getDay();
                        get_date_x.setDate(get_date_x.getDate()-this_day);
                        filter_periode_data = year_y +'-'+ (month_y) +'-'+ get_date_x.getDate();
                    }
                    console.log(filter_periode_data)
