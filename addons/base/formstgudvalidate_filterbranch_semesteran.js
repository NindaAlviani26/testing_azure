            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/base/formstg_filter.template?v=8", function (data) {
                    ...
                    var month_y = get_date_x.getUTCMonth(); //ambil bulan sembelumnya dalam numeric
                        ...
                        // check bulan semesteran
                    if(month_y == 0 || month_y == 1 || month_y == 2 || month_y == 3 || month_y == 4 || month_y == 5){
                        month_y = 12;
                    }else if(month_y == 6 || month_y == 7 || month_y == 8 || month_y == 9 || month_y == 10 || month_y == 11){
                        month_y = 6;
                    }
