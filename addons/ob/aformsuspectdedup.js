    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/ob/aformsuspectdedup.template?v=2", function (data) {
							...
							$.ajax({
								...
								success: function (message) {
									...
									if (message.status == "success") {
										...
										$.each(colModels, function(key, val){
											if(!columnSystem.includes(val.name)){
												var matchscore = message.data[0][val.name] * 100;
                    ...
                    jQuery("#" + msg.structure[0].idTable).jqGrid({
                        ...
                        loadComplete: function () {
                            ...
                            $("#" + msg.structure[0].idTable).resizeColumn('approvel', (colw - 100), true);
                        ...
                        onClickButton:function(){ 
                            ...
                            if (strprop==''){
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: "JSON",
                                    url: msg.structure[1].urlApprovel,
                                    data: strpropX,
                                    success: function(message){ 
                        ...
                        onClickButton:function(){ 
                            ...
                            if (strprop==''){
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: "JSON",
                                    url: msg.structure[3].urlApprovel,
                                    data: strpropX,
                                    success: function(message){ 
