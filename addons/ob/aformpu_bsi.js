    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/ob/aformpu.template?v=2", function (data) {
                    ...
                    $(".filterData").on("click", function(){
                        ...
                        url1 = encodeURI(msg.structure[0].urlLoadData + '&w='+whereFix);  
                        console.log(url1);
                        $("#"+msg.structure[0].idTable).jqGrid('clearGridData', true);
                        $("#"+msg.structure[0].idTable).jqGrid('setGridParam', { url: url1 });
