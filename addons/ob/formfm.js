    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/ob/formfm.template?v=1", function (data) {
                    ...
                    $('#' + msg.structure[0].idTable).jqGrid("navButtonAdd", "#pg_" + msg.structure[0].idTable + "_toppager", {
                        ...
                        onClickButton: function () {
                            ...
                            console.log(idsOfSelectedRows.length);

                            if (idsOfSelectedRows.length <= 1) {
                                alert("Please select more then one rows!");
                                return false;
                            }
                            else {
                                $("#loading").removeClass('hide');
                                ...
                                strprop = idsOfSelectedRows.join(",");
                                strpropX = 'id=' + strprop + ",";   
                                console.log( strpropX);
                                $.ajax({
                                    type: "POST",
                                    dataType: "JSON",
                                    url: msg.structure[0].urlFM,
                                    data: strpropX,
