                ...
                $.get("./templates/ob/rformclsstdmc.template?v=1", function (data) {
                    ...
                    jQuery("#" + msg.structure[0].idTable).jqGrid({
                        ...
                        onSelectRow: function (ids) {
                            ...
                            url2 = encodeURI(msg.structure[2].urlLoadData + '&w=' + where1);
                            url3 = encodeURI(msg.structure[3].urlLoadData + '&w=' + where1);
                            ...
                            $("#" + msg.structure[2].idTable).jqGrid('setGridParam', { url: url2 });
                            $("#" + msg.structure[2].idTable).trigger("reloadGrid");

                            $("#" + msg.structure[3].idTable).jqGrid('clearGridData', true);
                            $("#" + msg.structure[3].idTable).jqGrid('setGridParam', { url: url3 });
