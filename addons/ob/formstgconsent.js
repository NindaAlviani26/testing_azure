    ...
    $.ajax({
        ...
        success : function(msg){
            ...
            if(msg.status == 'success'){
                ...
                $.get( "./templates/ob/formstgconsent.template?v=3", function( data ) {
                        ...
                        jQuery("#" + msg.structure.idTable).jqGrid({
                            ...
                            }, //add
                            {
                                ...
                                onclickSubmit: function(eparams) {
                                    ...
                                    fieldname = jQuery("#"+msg.structure.idTable).jqGrid('getCell', jQuery("#"+msg.structure.idTable).jqGrid('getGridParam', 'selrow'), "field_name");
                                    retarr = "{\""+msg.structure.keyfield+"\" : \""+primarykey+"\", \"field_name\" : \""+fieldname+"\"}";
