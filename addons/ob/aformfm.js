    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/ob/aformfm.template?v=1", function (data) {
                    ...
                    var $grid = $("#" + msg.structure[0].idTable), idsOfSelectedRows = [],
                    ...
                    jQuery("#" + msg.structure[0].idTable).jqGrid({
                        ...
                        grouping: true,
                        groupingView: {
                            groupField: ['match_group'],
                            groupDataSorted: true,
                            groupCollapse: true,
                            groupText: ['<input type="checkbox" class="groupHeader" value="{0}"/>  {0}  </b>']
                        },
                        autowidth: true,
                        hidegrid: true,
                        multiselect: true,
                        ...
                        onSelectAll: function (aRowids, isSelected) {
                            ...
                            $(".groupHeader").prop('checked', isSelected);
                        },
                    ...
                    $('#' + msg.structure[0].idTable).jqGrid("navButtonAdd", "#pg_" + msg.structure[0].idTable + "_toppager", {
                        ...
                        onClickButton: function () {
                            ...
                            s = [];
                            $('.groupHeader:checked').each(function (i) {
                                s.push($(this).val());
                            });

                            if (s.length <= 0) {
                                alert("Please Check Data Before Reject...!");
                                return false;
                            }
                            else {
                                $("#loading").removeClass('hide');
