    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/ob/formreingest.template?v=1", function (data) {
                    ...
                    jQuery("#" + msg.structure[0].idTable).jqGrid({
                        ...
                        onSelectRow: function (ids, isSelected) {
                    ...
                    $('#' + msg.structure[0].idTable).jqGrid("navButtonAdd", "#pg_" + msg.structure[0].idTable + "_toppager", {
                        ...
                        onClickButton: function () {
                            ...
                            if (strprop==''){
                                ...
                                strpropX='cif='+strprop;
                                console.log(strpropX);
                                $.ajax({
                                    type: "POST",
                                    dataType: "JSON",
                                    url: msg.structure[0].urlreingest,
                                    data: strpropX,
                    ...
                    $('.glyphicon-cloud-upload').click(function () {
                        $("#upload" + msg.structure[1].idTable).click();
                    });
                    ...
                    r.assignBrowse(document.getElementById('upload'+msg.structure[1].idTable));
                    ...
                    if (!r.support) {
                        ...
                        r.on('fileSuccess', function (file, message) {
                            ...
                            $("#loading").removeClass('hide');
                            $.ajax({
                                url: msg.structure[1].uploadData + "&file_name=" + file.fileName,
                                type: "POST",
                                dataType: "JSON",
                        ...
                        onClickButton:function(){ 
                            ...
                            if (strprop==''){
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: "JSON",
                                    url: msg.structure[1].rejReingest,
                                    data: strpropX,
                                    success: function(message){ 
                        ...
                        onClickButton:function(){ 
                            ...
                            if (strprop==''){
                                ...
                                $.ajax({
                                    type: "POST",
                                    dataType: "JSON",
                                    url: msg.structure[1].appReingest,
                                    data: strpropX,
                                    success: function(message){ 
