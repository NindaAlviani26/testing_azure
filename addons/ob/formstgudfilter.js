    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/ob/formstgudfilter.template?v=2", function (data) {
                                ...
                                success: function(result_value_2){
                                    ...
                                    var alldata_child = $.extend({"": "All"}, data_child),
                                        ...
                                        $(".filterData").on("click", function(){
                                            ...
                                            url1 = encodeURI(msg.structure.urlLoadData + '&w='+whereFix);  
                                            console.log(url1);
                                            $("#"+msg.structure.idTable).jqGrid('clearGridData', true);
                                            $("#"+msg.structure.idTable).jqGrid('setGridParam', { url: url1 });
                                            $("#"+msg.structure.idTable).trigger("reloadGrid"); 
                                        })
