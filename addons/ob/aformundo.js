    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            if (msg.status == 'success') {
                ...
                $.get("./templates/ob/aformundo.template?v=1", function (data) {
                    ...
                    jQuery("#"+msg.structure[1].idTable).jqGrid({
                        ...
                        loadComplete: function (rowid) {
                            $.each(rowid.rows, function(idx, val){
                                console.log(val.cell[1]);
                                if(val.cell[1] != ''){
                                    
                                    // $('#'+msg.structure[1].idTable+' #' + val.cell[1]).css("background-color", "#f9f9b7");
                                   
                                    $('#'+msg.structure[1].idTable+' #' + val.cell[1]).addClass('warning');
                                }else if(val.cell[1] == ''){
                                    $('#'+msg.structure[1].idTable+' #' + val.cif).addClass('bg-white-select');
                                }
