		...
		return this.each(function() {
			...
			for(i = 0; i<clone; i++) {
				...
				if (o.help) {
					...
					.click(function(){
						window.open('./addons/pdfviewer/viewer.php?pdf='+pHelp.helppdffile+'#'+pHelp.helppage,'PDF Helps','directories=no,titlebar=no,toolbar=no,location=0,address=0,status=no,menubar=no,scrollbars=no,resizable=no,width=600,height=550');
						return false;
					}).hover(onHoverIn, onHoverOut);
					tbd = null;
				}
