  ...
  $.fn.extend({
    tableExport: function (options) {
      ...
      if (defaults.type == 'csv' || defaults.type == 'tsv' || defaults.type == 'txt') {
		...
		rowlength += CollectCsvData ($("[aria-labelledby=gbox_"+$(this).attr('id')+"]").find('thead').first().find(defaults.theadSelector), 'th,td', rowlength);
		
		
		//console.log( $("[aria-labelledby=gbox_"+$(this).attr('id')+"]").find('thead').html());
		//alert( $(this).attr('id'));
      ...
      function GetColumnNames (table) {
        var result = [];
		//console.log($('.ui-jqgrid-htable').find('thead').find('th'));
        $('.ui-jqgrid-htable').find('thead').find('th').each(function(index, el) {
